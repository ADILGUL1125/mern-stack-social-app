...
import {Users,UserPlus, UserCheck,UserRoundPen,MessageSquare, Dice1} from "lucide-react"
import {useNavigate} from "react-router"
import {
  dummyConnectionsData as Connections,
  dummyFollowersData as follower,
  dummyFollowingData as following,
  dummyPendingConnectionsData as pendingconnection
} from "../assets/assets/assets.js"
const Connection = () => {
  const [currenttab,setcurrenttab]=useState('Follower')
  let  navigate  =useNavigate()
  const dataarray =[
    {label:"Follower",value :follower,icon:Users},
  ...
  return (
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        {/* title */}
        <div className=' mb-8'>
        <h1  className='text-3xl font-bold text-slate-900 mb-2'>Connectios</h1>
              ...
              <div key={user._id} className='w-full max-w-88 flex gap-5 p-6 bg-white shadow rounded-md'>
                ...
                <div className='flex-1'>
                  ...
                  <div className='flex max-sm:flex-col gap-2 mt-4'>
                    {
                      <button onClick={()=>navigate('/profile/'+user._id)} className='w-full p2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer '>
                        View profile
